...
class Repository
{
    ...
    private $replacements = [
        ...
        'zend-debug' => 'zend-debug',
        // zf-deploy:
        'zfcampus/zf-deploy' => 'zfcampus/zf-deploy',
        'zf-deploy' => 'zf-deploy',
        'zfdeploy' => 'zfdeploy',
        'ZFDeploy' => 'ZFDeploy',
        'ZF\\\\Deploy' => 'ZF\\\\Deploy',
        'ZF\\Deploy' => 'ZF\\Deploy',
        'ZFTest\\\\Deploy' => 'ZFTest\\\\Deploy',
        'ZFTest\\Deploy' => 'ZFTest\\Deploy',
        // Rewrite rules:
        // laminas-xml:
        'use ZendXml' => 'use Laminas\\Xml',
        'ZendXml;' => 'Laminas\\Xml;',
        'ZendXml\\\\' => 'Laminas\\\\Xml\\\\',
        ...
        'use ZendOAuth' => 'use Laminas\\OAuth',
        'ZendOAuth;' => 'Laminas\\OAuth;',
        'ZendOAuth\\\\' => 'Laminas\\\\OAuth\\\\',
        'ZendOAuthTest\\\\' => 'LaminasTest\\\\OAuth\\\\',
        'ZendOAuthTest' => 'LaminasTest\\OAuth',
        'ZendOAuth' => 'laminas-oauth',
        'zendframework/ZendOAuth' => 'laminas/laminas-oauth',
        '/ZendOAuth' => '/Laminas/OAuth',
        '/ZendOAuthTest' => '/LaminasTest/OAuth',
        'zendoauth' => 'laminas-oauth',
        // laminas-diagnostics:
        ...
        'Zend Technologies USA Inc.' => 'Laminas',
        'http://www.zend.com' => 'https://www.zend.com',
        'www.zend.com' => 'www.zend.com',
        'zend.com' => 'zend.com',
        'zend\.com' => 'zend\.com',
